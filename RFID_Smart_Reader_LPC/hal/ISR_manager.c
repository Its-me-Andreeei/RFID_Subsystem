...
void InitInterrupt(void)
{
	...
	#define TIMER1_ISR_NUM_U8 ((u8)5U)
	#define SPI0_ISR_NUM_U8 ((u8)10U)
	#define EINT2_ISR_NUM_U8 ((u8)16U)
	
	RingBufInit(&uart1_ringbuff_rx, uart1_buffer, UART1_BUFFER_SIZE);
	
	VICIntEnable |= (1 << TIMER0_ISR_NUM_U8) | (1 << UART1_ISR_NUM_U8) | (1 << I2C_ISR_NUM_U8) | (1 << SPI0_ISR_NUM_U8) | (1 << EINT2_ISR_NUM_U8) | (1 << TIMER1_ISR_NUM_U8);
	...
	VICVectCntl4 = TIMER1_ISR_NUM_U8 			 | (1 << ISR_ENABLE_BIT);
	...
	VICVectAddr4 = (unsigned long int)timer1_irq;
}
